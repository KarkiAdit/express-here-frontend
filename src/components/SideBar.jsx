...
const SideBar = (props) => {
    ...
    const fetchSavedPosts = async () => {
        try {
            const response = await fetch(`https://express-here.herokuapp.com/userprofile/savedposts/${props.user.userID}`);
    ...
    const handleDelete = async (e) =>{
        e.preventDefault()
        try{
            const response = await fetch(`https://express-here.herokuapp.com/username/delete/savedposts/${props.user.userID}`, {
            method: "DELETE",
